...
public class Menu : MonoBehaviour
{
    ...
    public void toggleMenu(GameObject submenu, Transform controller)
    {
        ...
        else if (currentState == 1 && submenu != null)
        {
            ...
            currentlyActive.transform.position = new Vector3(controller.transform.position.x, controller.transform.position.y - 0.1f, controller.transform.position.z);
            currentlyActive.transform.rotation = Quaternion.Euler(new Vector3(controller.transform.rotation.eulerAngles.x, controller.transform.rotation.eulerAngles.y, currentlyActive.transform.rotation.eulerAngles.z));
            currentState = 2;
